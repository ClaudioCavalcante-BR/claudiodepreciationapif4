...
import br.edu.infnet.mono.model.clients.ParallelumClient;
import br.edu.infnet.mono.model.clients.ParallelumClient.Brand;
import br.edu.infnet.mono.model.clients.ParallelumClient.ModelsResponse;
import br.edu.infnet.mono.model.clients.ParallelumClient.Year;
import br.edu.infnet.mono.model.clients.ParallelumClient.VehicleDetail;
...
public class AssetCategoryController {
	 ...
	 private final ParallelumClient parallelumClient;
	    ...
	    public AssetCategoryController(AssetCategoryService assetCategoryService, ParallelumClient parallelumClient) {
	 ...
	 // Conveniência: detalhe por ANO sempre como diesel ("-3")
